	...
	if(winWidth > 1367){
	    ...
	    new Waypoint({
			...
			function(direction) {
				...
				$('#charging .square_small').delay(300).css({left:-50}).animate({left:0,'opacity':1},1000)
				$('#charging .square_main,#charging .product_logo').css({left:-50}).animate({left:0,'opacity':1},1000)
				this.destroy()
			},
			offset: '17%'
	    })
